...
// Seed data for initial Holako setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Holako store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Holako. All rights reserved.',
  },
  settings: {
    siteName: 'Holako',
